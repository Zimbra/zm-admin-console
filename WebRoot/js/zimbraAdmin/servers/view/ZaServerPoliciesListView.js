 ...
 **/
ZaServerPoliciesListView = function(parent, className, posStyle, headerList) {
	//var headerList = this._getHeaderList();
	ZaListView.call(this, parent, className, posStyle, headerList);
}

ZaServerPoliciesListView.prototype = new ZaListView;
ZaServerPoliciesListView.prototype.constructor  = ZaServerPoliciesListView;
ZaServerPoliciesListView.prototype.toString = function() {
	return "ZaServerPoliciesListView";
};

ZaServerPoliciesListView.prototype._createItemHtml =
function(item) {
	...
	var idx = 0;
	html[idx++] = "<table width='100%' cellspacing='0' cellpadding='0' id='bhavin-policy-list'>";
...
ZaServerPoliciesListView.prototype._setNoResultsHtml = function() {
...
ZaServerPoliciesListView.prototype._sortColumn = function (columnItem, bSortAsc){
	if (bSortAsc) {
