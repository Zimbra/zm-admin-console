						...
						},
						{
							...
							visibilityChecks:[
								[
									ZATopGrouper_XFormItem.isGroupVisible,
									[
										ZaAccount.A_zimbraFeatureTwoFactorAuthAvailable,
										...
										ZaAccount.A_zimbraFeatureAppSpecificPasswordsEnabled
									]
								]
							],
							items : [
								...
								},
								{
									...
									type : _SUPER_CHECKBOX_,
									enableDisableChecks : [
										[XForm.checkInstanceValue, ZaAccount.A_zimbraTwoFactorAuthEnabled, "TRUE"],
										[XForm.checkInstanceValue, ZaAccount.A_zimbraFeatureTwoFactorAuthAvailable, "TRUE"]
									],
									enableDisableChangeEventSources : [ZaAccount.A_zimbraFeatureTwoFactorAuthAvailable, ZaAccount.A_COSId],
									checkBoxLabel : ZaMsg.LBL_Two_Factor_Authentication_Active,
									msgName : ZaMsg.LBL_Two_Factor_Authentication_Active,
									trueValue : "TRUE",
									falseValue : "FALSE",
									resetToSuperLabel : ZaMsg.NAD_ResetToCOS,
									checkBoxElementChanged : function(elementValue,instanceValue, event) {
										if (elementValue === "FALSE") {
											this.disableElement();
											//Disable the Reset to COS value button
											this.getParentItem().getItems()[1].setElementEnabled(false);
										}
										this.elementChanged(elementValue,instanceValue, event);
									}
								},
								{
