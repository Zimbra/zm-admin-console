...
ZaCosXFormView.ADVANCED_TAB_ATTRS = [ZaCos.A_zimbraAttachmentsBlocked,
	...
	ZaCos.A_zimbraFeaturePasswordExpiryReminderEnabled,
        ...
        var case2Items = [
            ...
            {type:_ZA_TOP_GROUPER_,  label:ZaMsg.NAD_zimbraGeneralFeature, id:"cos_form_features_general",
                ...
                items:[
                    ...
                    {ref:ZaCos.A_zimbraFeatureDocumentEditingEnabled, type:_CHECKBOX_, msgName:ZaMsg.LBL_zimbraFeatureDocumentEditingEnabled,label:ZaMsg.LBL_zimbraFeatureDocumentEditingEnabled, trueValue:"TRUE", falseValue:"FALSE"},
            ...
            {type:_ZA_TOP_GROUPER_,  label:ZaMsg.NAD_zimbraResetPasswordFeature, id:"cos_form_features_reset_password",
                visibilityChecks:[[ZATopGrouper_XFormItem.isGroupVisible,
                    [
                        ZaCos.A_zimbraFeatureResetPasswordStatus
                    ]]
          ...
          content: ZaMsg.NAD_ZERO_UNLIMETED
...

            {
                ...
                items: [
                    ...
                    {
                        ref: ZaCos.A_zimbraFeatureAllowUsernameInPassword, type: _CHECKBOX_,
                    ...
                    {
                        ref: ZaCos.A_zimbraFeaturePasswordExpiryReminderEnabled, type: _CHECKBOX_,
                        msgName: ZaMsg.NAD_PasswordExpiryReminder,
                        label: ZaMsg.NAD_PasswordExpiryReminder,
                        trueValue: "TRUE", falseValue: "FALSE",
                        visibilityChecks: [], enableDisableChecks: [[ZaCosXFormView.isAllAuthfromInternal]]
                    }
                ]
