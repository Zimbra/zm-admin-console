...
ZaNewCosXWizard.isTwoFactorAuthFeatureEnabled = function() {
...
ZaNewCosXWizard.isChatFeatureEnabled = function () {
...
ZaNewCosXWizard.myXFormModifier = function(xFormObject, entry) {
        ...
        var case2Items = [
            {type:_ZAWIZ_TOP_GROUPER_,  label:ZaMsg.NAD_zimbraMajorFeature, id:"cos_form_features_major",
                ...
                items:[
                    ...
                    {ref:ZaCos.A_zimbraFeatureChatEnabled, type:_WIZ_CHECKBOX_, msgName:ZaMsg.LBL_zimbraFeatureChatEnabled,label:ZaMsg.LBL_zimbraFeatureChatEnabled,  trueValue:"TRUE", falseValue:"FALSE"},
            ...
            {type:_ZA_TOP_GROUPER_,  label:ZaMsg.NAD_zimbraChatFeature, id:"cos_form_features_im",
                visibilityChecks:[ZaNewCosXWizard.isChatFeatureEnabled],
    ...
    if(_tab3) {
        ...
        var case3Items = [
            ...
            {type:_ZAWIZ_TOP_GROUPER_, id:"cos_prefs_chat_general",
                ...
                items :[
                    {ref:ZaCos.A_zimbraPrefChatPlaySound, type:_WIZ_CHECKBOX_,
    ...
    if(_tab7) {
        ...
        var case7Items = [
          ...
          content: ZaMsg.NAD_ZERO_UNLIMETED
			...
			{
				type: _ZAWIZ_TOP_GROUPER_,
				id: "cos_two_factor_authentication_settings",
				...
				items : [
					...
					},
					{
						...
						type : _WIZ_CHECKBOX_,
						enableDisableChecks : [ZaNewCosXWizard.isTwoFactorAuthFeatureEnabled],
					...
					},
					{
						...
						subLabel : ZaMsg.LBL_Number_Of_One_Time_Codes,
