    ...
    if(_tab2) {
        ...
        var case2Items = [
            ...
            {ref:ZaCos.A_zimbraFeatureConversationsEnabled, type:_WIZ_CHECKBOX_, msgName:ZaMsg.LBL_zimbraFeatureConversationsEnabled,label:ZaMsg.LBL_zimbraFeatureConversationsEnabled,trueValue:"TRUE", falseValue:"FALSE"},
                        ...
                        {ref:ZaCos.A_zimbraFeatureDeliveryStatusNotificationEnabled, type:_WIZ_CHECKBOX_,label:ZaMsg.LBL_zimbraDeliveryStatusNotificationEnabled,trueValue:"TRUE", falseValue:"FALSE"}
                ]
            },
            {
    ...
    if(_tab3) {
        ...
        var case3Items = [
            ...
            {type:_ZAWIZ_TOP_GROUPER_, id:"cos_prefs_mail_sending",borderCssClass:"LowPaddedTopGrouperBorder",label:ZaMsg.NAD_MailOptionsSending,
                ...
                {ref:ZaCos.A_zimbraPrefMailDeliveryStatusNotification, type:_WIZ_CHECKBOX_, msgName:ZaMsg.LBL_zimbraDeliveryStatusNotificationEnabled,label:ZaMsg.LBL_zimbraDeliveryStatusNotificationEnabled,
                    trueValue:"TRUE", falseValue:"FALSE"
                },
            ]},
          ...
          content: ZaMsg.NAD_ZERO_UNLIMETED
...

            {
                ...
                items: [
                    ...
                    {
                        ref: ZaCos.A_zimbraFeaturePasswordExpiryReminderEnabled, type: _WIZ_CHECKBOX_,
