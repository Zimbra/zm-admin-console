...
ZaAuthenticate.prototype.changePassword = function(uname, oldPass, newPass, callback) {
...
ZaAuthenticate.prototype.execute = function(uname, pword, callback) {
...
ZaAuthenticate.prototype._processResponse = function(resp) {
    ...
    for (var i = 0; i < len; i++) {
        el = els[i];
        /*
         * if (el.nodeName == "authToken") authToken = el.firstChild.nodeValue;
         * else if (el.nodeName == "lifetime") lifetime =
