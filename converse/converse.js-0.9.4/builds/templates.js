...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<dl class="hidden add-converse-contact dropdown">\n    <dt id="xmpp-contact-search" class="fancy-dropdown">\n        <a class="toggle-xmpp-contact-form" href="#"\n            title="' +
...
'"></a-->\n    <span class="close-chatbox-button icon-minimize"></span>\n    <span class="icon-plus"></span>\n    <span class="icon-search"></span>\n</div>\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<li class="hidden"><a class="s" href="#chatrooms">' +
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<form class="hidden set-xmpp-status" action="" method="post">\n    <span id="xmpp-status-holder">\n        <select id="select-xmpp-status" style="display:none">\n            <option value="online">' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="zmchat-controlbox-toggle">\n\t<span style="display: none" id="online-count">0</span>\n\t<span class="conn-feedback">' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<li class="hidden"><a class="s" href="#register">' +
((__t = (label_register)) == null ? '' : __t) +
'</a></li>\n';
